...
from heat_timestepping import heat_timestepping
...
if __name__=="__main__":
    ...
    out = heat_timestepping(input_args())

    #Save output
    filename = 'tmp/heatsteppingdat%s%s%s%s%s%s%s' % (args.tmpname, args.N, args.dt,
                                                      args.tdegree, args.sdegree,
                                                      args.Mbase, args.Mref)
